...
# Example usage
input_file = "../01_raw_data/cleaned_raw_data/parsed_proteins.json"
output_file= "../01_raw_data/cleaned_raw_data/filtered_proteins_with_GO_ids.json"
filter_proteins_with_go_ids(input_file, output_file, name_to_id)
